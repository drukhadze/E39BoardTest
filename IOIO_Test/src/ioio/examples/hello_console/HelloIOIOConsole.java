...
//			private AnalogInput		geber3 = null;
			AnalogGeberNTC geber1 = null;
			AnalogGeberNTC geber2 = null;
			AnalogGeberNTC geber3 = null;
...
//				System.out.println("GEBER3: " + geber3.getValue() + " C ");
				System.out.println(String.format("GEBER1: %.3f C, GEBER2: %.3f C, GEBER3: %.3f C", geber1.getValue(), geber2.getValue(), geber3.getValue()));
			}
